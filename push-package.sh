...
dotnet nuget push src/NHibernate.NetCore/bin/Release/NHibernate.NetCore.6.0.0.nupkg -s nuget.org -k $(cat ~/.nuget/key.txt)
...
dotnet nuget push src/NHibernate.Extensions.NpgSql/bin/Release/NHibernate.Extensions.NpgSql.6.0.0.nupkg -s nuget.org -k $(cat ~/.nuget/key.txt)
...
dotnet nuget push src/NHibernate.Extensions.Sqlite/bin/Release/NHibernate.Extensions.Sqlite.6.0.0.nupkg -s nuget.org -k $(cat ~/.nuget/key.txt)
