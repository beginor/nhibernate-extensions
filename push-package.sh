...
dotnet nuget push src/NHibernate.NetCore/bin/Release/NHibernate.NetCore.5.0.3.nupkg -s nuget.org -k $(cat ~/.nuget/key.txt)
...
dotnet nuget push src/NHibernate.Extensions.NpgSql/bin/Release/NHibernate.Extensions.NpgSql.5.0.3.nupkg -s nuget.org -k $(cat ~/.nuget/key.txt)
...
dotnet nuget push src/NHibernate.Extensions.Sqlite/bin/Release/NHibernate.Extensions.Sqlite.5.0.3.nupkg -s nuget.org -k $(cat ~/.nuget/key.txt)
