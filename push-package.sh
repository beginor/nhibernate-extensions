...
dotnet nuget push src/NHibernate.NetCore/bin/Release/NHibernate.NetCore.3.1.4.nupkg -s nuget.org -k $(cat ~/.nuget/key.txt)
...
dotnet nuget push src/NHibernate.Extensions.NpgSql/bin/Release/NHibernate.Extensions.NpgSql.3.1.6.nupkg -s nuget.org -k $(cat ~/.nuget/key.txt)
...
dotnet nuget push src/NHibernate.Extensions.Sqlite/bin/Release/NHibernate.Extensions.Sqlite.2.0.3.nupkg -s nuget.org -k $(cat ~/.nuget/key.txt)
